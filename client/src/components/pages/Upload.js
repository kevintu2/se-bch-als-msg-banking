        ...
        <div>
            ...
            <Form.Group controlId="formFile" class="col-lg-6 offset-lg-3"  >
                <div className="row justify-content-center">
                    ...
                    <Form.Control type="input" style={{width:'50%'}} name="title" onChange={(e) => setTitle(e.target.value)}></Form.Control>
                    <Form.Label>Upload your data</Form.Label>
                    <Form.Control type="file" style={{width:'50%'}} name="file" onChange={(e) => setFile(e.target.files[0])}/>
